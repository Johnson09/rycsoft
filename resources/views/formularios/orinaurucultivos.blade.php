...
<div class="container-fluid">
    <div class="row justify-content-center text-center">
        <div class="container-fluid text-center">
            <h1 style="color: #2c53c5; margin-top: -0.8em;"><b>Consentimiento Toma Parcial Orina y Urucultivos</b></h1>
        ...
        <div style="text-align: center;">
            ...
            <form role="form" id="form" action="{{ url('formulario_orina') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-md-12">
                    <table id="section1" class="table table-hover" style="text-align: justify;">
                        <tr>
                            <th>
                                <p><b>PROCEDIMIENTO:</b> El sondaje uretral es un procedimiento invasivo, simple y seguro que consiste en la
                                extracción de una muestra de orina mediante la introducción de una sonda a través de la uretra hasta
                                alcanzar el interior de la vejiga urinaria. La vejiga es el depósito en el cual la orina proveniente de los
                                riñones es almacenada antes de ser evacuada durante una micción. La uretra es el canal de salida de la
                                vejiga. La sonda es un tubo delgado y flexible que se introduce en la vejiga a través del canal de la uretra,
                                para obtener muestras de orina y hacer un adecuado diagnóstico ante la presencia de infecciones
                                urinarias.</p>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <p><b>RIESGOS FRECUENTES A</b> pesar de que el procedimiento ha sido realizado correctamente desde el
                                punto de vista técnico siempre pueden presentarse efectos indeseables o complicaciones. Las
                                complicaciones en general son pocos frecuentes. Lo más común es que aparezca un sangrado urinario
                                transitorio visible solamente con microscopio o visible a simple vista en el 1% de los casos.</p>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <p>RIESGOS POCO FRECUENTES, CUANDO SEAN DE ESPECIAL GRAVEDAD Y ESTÉN ASOCIADOS
                                AL PROCEDIMIENTO POR CRITERIOS CIENTÍFICOS Otras complicaciones poco frecuentes que puede
                                ocurrir en menos de un 1% de los casos son la infección urinaria y excepcionalmente la rotura de la
                                uretra o vejiga siendo estas complicaciones más frecuentes en los niños portadores de sonda
                                permanente.</p>
                            </th>
                        </tr> 
                        <tr>
                            <th>
                                <p>CONTRAINDICACIONES 1. Prostatitis aguda. 2. Uretritis aguda, flemones y abscesos periuretrales. 3.
                                Estenosis o rigidez uretral. 4. Sospecha de rotura uretral traumática. 5. Alergia conocida al latex.</p>
                            </th>
                        </tr> 
                        <tr>
                            <th>
                                <p>Declaro que he comprendido adecuadamente la información y doy mi consentimiento informado para la
                                realización del procedimiento mencionado durante la realización de la técnica conforme al plan
                                terapéutico, habiendo recibido explicación de las indicaciones, riesgos y/o complicaciones potenciales y
                                beneficios enunciados. Comprendo también que en cualquier momento y sin necesidad de dar ninguna
                                explicación, puedo solicitar la revocatoria de este consentimiento informado y eximir al profesional de mi
                                atención.</p>
                            </th>
                        </tr>      
                    </table>
            ...
            <div style="width: 45em; text-align: justify;">
                <p>Nombre del testigo: <input type="text" name="nombre_testigo" onkeyup="Textos(this);"> N° Documento Identidad: <input type="number" name="documento_testigo" maxlength="10"></p>
