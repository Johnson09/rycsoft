...
<div class="container-fluid">
    <div class="row justify-content-center text-center">
        <div class="container-fluid text-center">
            <h1 style="color: #2c53c5; margin-top: -0.8em;"><b>Consentimiento Examen Frotis Flujo Vaginal</b></h1>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-md-12">
                    <table id="section1" class="table table-hover" style="text-align: justify;">
                        <tr>
                            <th>
                                <p>El examen de frotis flujo vaginal: Es una técnica que consiste tomar una muestra que
                                implica la observación microscópica de células extraídas del conducto vaginal con ayuda
                                de un isopo, empleado para detectar infecciones, inflamación e identificación de diferentes
                                gérmenes. No existe ningún riesgo identificado al tomar las muestras del conducto
                                vaginal, incluso si usted se encuentra embarazada actualmente. Cuando el cuello del
                                útero se encuentra muy inflamado, en ocasiones se presenta escaso sangrado vaginal
                                (manchado), que cede solo y no requiere tratamiento.</p>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <p>Declaro que me ha explicado en forma clara, precisa, concisa y lenguaje sencillo todos los
                                Riesgos y Complicaciones, me han dado la oportunidad de realizar preguntas, aclarar
                                dudas y observaciones.</p>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <p>Doy mi consentimiento informado para la realización del procedimiento mencionado
                                durante la realización de la técnica conforme al plan terapéutico, habiendo recibido
                                explicación de las indicaciones, riesgos y/o complicaciones potenciales y beneficios
                                enunciados. Comprendo también que en cualquier momento y sin necesidad de dar
                                ninguna explicación, puedo solicitar la revocatoria de este consentimiento informado y
                                eximir al profesional de mi atención.</p>
                            </th>
                        </tr>     
                    </table>
                </div>
