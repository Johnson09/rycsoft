                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-md-12">
                            <div class="form-group" style="text-align: justify;">
                                ...
                                <canvas id="firma1" name="firma_consultante" width="500" height="100" style="border: 5px solid black; display: none;">
                                </canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-md-12">
                            <div class="form-group" style="text-align: justify;">
                                ...
                                <canvas id="firma2" name="firma_responsable" width="500" height="100" style="border: 5px solid black; display: none;">
                                </canvas>
                            </div>
                        </div>
                    </div>
